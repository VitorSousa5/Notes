...
*If a collection of random variables $X_1, X_2, \ldots, X_n$ are independent, then their joint distribution is the product of their individual densities or mass functions That is, if $f_i$ is the density for random variable $X_i$ we have that*
$$
